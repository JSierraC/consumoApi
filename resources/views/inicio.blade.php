...
<body>
  ...
  @vite('resources/statics/js/isotope.min.js')
  @vite('resources/statics/js/owl-carousel.js')
  
  @vite('resources/statics/js/tabs.js')
  @vite('resources/statics/js/popup.js')
  @vite('resources/statics/js/custom.js')
